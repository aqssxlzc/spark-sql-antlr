...
public interface SparksqlListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SparksqlParser#create_statement}.
	 * @param ctx the parse tree
	 */
	void enterCreate_statement(SparksqlParser.Create_statementContext ctx);
	/**
	 * Exit a parse tree produced by {@link SparksqlParser#create_statement}.
	 * @param ctx the parse tree
	 */
	void exitCreate_statement(SparksqlParser.Create_statementContext ctx);
	/**
	 * Enter a parse tree produced by {@link SparksqlParser#drop_statement}.
	 * @param ctx the parse tree
	 */
	void enterDrop_statement(SparksqlParser.Drop_statementContext ctx);
	/**
	 * Exit a parse tree produced by {@link SparksqlParser#drop_statement}.
	 * @param ctx the parse tree
	 */
	void exitDrop_statement(SparksqlParser.Drop_statementContext ctx);
	/**
	 * Enter a parse tree produced by {@link SparksqlParser#drop_condition}.
	 * @param ctx the parse tree
	 */
	void enterDrop_condition(SparksqlParser.Drop_conditionContext ctx);
	/**
	 * Exit a parse tree produced by {@link SparksqlParser#drop_condition}.
	 * @param ctx the parse tree
	 */
	void exitDrop_condition(SparksqlParser.Drop_conditionContext ctx);
	/**
